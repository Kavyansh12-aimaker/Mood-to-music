...
import { Search, Heart, Home, Info, Music2 } from 'lucide-react';
    ...
    <nav className="sticky top-0 z-50 w-full px-6 py-6">
      <div className="max-w-7xl mx-auto flex items-center justify-between">
        <Link to="/" className="flex items-center gap-3 group">
          <div className="w-12 h-12 bg-white flex items-center justify-center rounded-2xl group-hover:rotate-6 transition-transform duration-500 shadow-xl">
